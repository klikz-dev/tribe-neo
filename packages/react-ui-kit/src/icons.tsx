...
export const DotsVerticalIcon: FC<IconProps> = props => (
  <svg
...
export const ExclamationOutlineIcon: FC<IconProps> = props => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-6 w-6"
    fill="none"
...
export const DotIcon: FC<IconProps> = props => (
  <svg className="h-2 w-2" fill="currentColor" viewBox="0 0 8 8" {...props}>
...
export const SelectorIcon: FC<IconProps> = props => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-5 w-5"
    viewBox="0 0 20 20"
